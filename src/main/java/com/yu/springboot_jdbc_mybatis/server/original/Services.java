...
public interface Services {
    ...
    List<Menu> QueryAllMenuCommentsByPage(int comments,String Review,int start,int end);//一个查询评论选项卡的方法
    List<MenuVo> QueryAllMenuYearByPage(String year,String Review,int start,int end, String applicationid);//一个查询年选项卡的方法
    List<MenuVo> QueryListsByPage(int RigHtTo,String Review,int start,int end);//普通全部内容



    int QueryAllMenuCommentsByPageCount(int comments,String Review);//一个查询评论选项卡的方法数量
    int QueryAllMenuYearByPageCount(String year,String Review,String applicationid);//一个查询年选项卡的方法数量
    ...
    //弃用
    void Fortitleid(int titleid,String menutitle,String applicationid);//修改titleid
    ...
    List<Topiccomments> QueryComment(String topictitle,String applicationids);//查询所有评论
    ...
    void deletetopiccomments(String menutitle,String applicationid);//删除评论单个
    void deletereplecomments(String repletitle,String applicationid);//删除回复单个



    void deletetopiccommentsall(List<String> topictitle,List<String>applicationid);//删除评论多行
    void deletereplecommentsall(List<String> repletitle,List<String> applicationid);//删除回复多行
    ...
    List<Menu> QueryTitlidMax(String applicationid);
    List<RepleComments> queryRepleComments(String menutitle,String applicationid);//查看所有回复信息

    List<Topiccomments> queryTopiccommentsandRepleComments(String menutitle); //查询连表评论与回复 无法使用
